...
--handleKline--:  version='2.0.0', self.name='amihud', self.symbol='BTCUSDT', interval='5m', intervalSec=300, wid=144, thd=0.8, self.sign=-1, self.total=993672.4896432, self.flagDict['side']='sell', self.tradeCount=2, self.count=2932
self.closeSec=1670408399, self.tradeDate='20221207', self.openTime='181500', self.closeTime='181959', self.symbol='BTCUSDT', self.open=16797.6, self.close=16797.7, self.high=16805.0, self.low=16790.2, self.vol=1780.327, self.amt=29905718.1998 
2022-12-07 18:20:00,445:INFO:amihud:main.py:172:handleKline:200676: ukdf.iloc[-5:,:] :
...
[5 rows x 18 columns]
2022-12-07 18:20:00,445:INFO:amihud:main.py:175:handleKline:200676: self.closeSec=1670408399, self.tradeDate='20221207', self.openTime='181500', self.closeTime='181959',self.symbol='BTCUSDT',self.open=16797.6, self.close=16797.7, self.high=16805.0, self.low=16790.2, self.vol=1780.327, self.amt=29905718.1998, ukdf['pct'].iloc[-1]=-9.5e-05 , ukdf['amount'].iloc[-1]=29905718.1998, ukdf['indicator'].iloc[-1]=0.0, ukdf['index'].iloc[-1]=5979, value=0.0, value_mean=0.14956925951872907, signal=0, value_std=0.2859495636823106 
queryPositions: self.symbol='BTCUSDT', positions=PositionsReturn{'result': [PositionType{'sysID': SystemID{'mainID': '', 'subID': '', 'strategyID': ''}, 'symbol': 'BTCUSDT', 'positionAmount': '60.176', 'enterprice': '16529.3', 'countrevence': '0', 'unrealprofit': '-16151.2384', 'marginmodel': 0, 'isolatedmargin': '0', 'positionside': 'short', 'markprice': '16797.7', 'status': 'none', 'closeprice': '0', 'closeamount': '0', 'opentime': 0, 'closetime': 0, 'type': 'AssetType_ucontract'}]}
type(curSign)=<class 'int'>, curSign=0, self.sign=-1
--handleKline--:  version='2.0.0', self.name='amihud', self.symbol='BTCUSDT', interval='5m', intervalSec=300, wid=144, thd=0.8, self.sign=-1, self.total=993672.4896432, self.flagDict['side']='sell', self.tradeCount=2, self.count=2933
self.closeSec=1670408699, self.tradeDate='20221207', self.openTime='182000', self.closeTime='182459', self.symbol='BTCUSDT', self.open=16797.8, self.close=16792.7, self.high=16801.1, self.low=16792.0, self.vol=877.702, self.amt=14742191.7663 
127.0.0.1 - - [07/Dec/2022 18:25:01] "POST / HTTP/1.1" 200 -
2022-12-07 18:25:01,452:INFO:amihud:main.py:172:handleKline:200676: ukdf.iloc[-5:,:] :
     tradeDate openTime closeTime  ...  value_mean  value_std  signal
5976  20221207   180000    180459  ...    0.150062   0.286200       0
5977  20221207   180500    180959  ...    0.149898   0.286117       0
5978  20221207   181000    181459  ...    0.149734   0.286034       0
...
[5 rows x 18 columns]
2022-12-07 18:25:01,453:INFO:amihud:main.py:175:handleKline:200676: self.closeSec=1670408699, self.tradeDate='20221207', self.openTime='182000', self.closeTime='182459',self.symbol='BTCUSDT',self.open=16797.8, self.close=16792.7, self.high=16801.1, self.low=16792.0, self.vol=877.702, self.amt=14742191.7663, ukdf['pct'].iloc[-1]=-0.000298 , ukdf['amount'].iloc[-1]=14742191.7663, ukdf['indicator'].iloc[-1]=0.0, ukdf['index'].iloc[-1]=5980, value=0.0, value_mean=0.14941164711190044, signal=0, value_std=0.28587557792781626 
queryPositions: self.symbol='BTCUSDT', positions=PositionsReturn{'result': [PositionType{'sysID': SystemID{'mainID': '', 'subID': '', 'strategyID': ''}, 'symbol': 'BTCUSDT', 'positionAmount': '60.176', 'enterprice': '16529.3', 'countrevence': '0', 'unrealprofit': '-15850.3584', 'marginmodel': 0, 'isolatedmargin': '0', 'positionside': 'short', 'markprice': '16792.7', 'status': 'none', 'closeprice': '0', 'closeamount': '0', 'opentime': 0, 'closetime': 0, 'type': 'AssetType_ucontract'}]}
type(curSign)=<class 'int'>, curSign=0, self.sign=-1
...
self.closeSec=1670408399, self.tradeDate='20221207', self.openTime='181500', self.closeTime='181959', self.symbol='BTCUSDT', self.open=16797.6, self.close=16797.7, self.high=16805.0, self.low=16790.2 
2022-12-07 18:20:00,414:INFO:factorcheck2:main.py:126:handleKline:185239: self.closeSec=1670408399, self.tradeDate='20221207', self.openTime='181500', self.closeTime='181959',self.symbol='BTCUSDT',self.open=16797.6, self.close=16797.7, self.high=16805.0, self.low=16790.2   
127.0.0.1 - - [07/Dec/2022 18:20:00] "POST / HTTP/1.1" 200 -
2022-12-07 18:20:00,438:INFO:factorcheck2:main.py:127:handleKline:185239: ukdf.iloc[-5:,:] :
...
[5 rows x 11 columns]
2022-12-07 18:20:00,438:INFO:factorcheck2:main.py:128:handleKline:185239: self.flagDict={'side': 'buy', 'posBuy': 0, 'posSell': 0, 'isNewDay': True, 'isOpenBuy': True, 'isOpenSell': False, 'isCloseBuy': False, 'isCloseSell': False, 'isOpen': True, 'isClose': False, 'isTrig': True}
127.0.0.1 - - [07/Dec/2022 18:25:01] "POST / HTTP/1.1" 200 -

--handleKline--:  version='2.0.6', self.name='factorcheck2', self.symbol='BTCUSDT', interval='5m', intervalSec=300, wid=40, wid2=50, thd=0.6, self.factorCnt=0, self.factor=0.6038728964274044, self.count=3499 

self.closeSec=1670408699, self.tradeDate='20221207', self.openTime='182000', self.closeTime='182459', self.symbol='BTCUSDT', self.open=16797.8, self.close=16792.7, self.high=16801.1, self.low=16792.0 
2022-12-07 18:25:01,393:INFO:factorcheck2:main.py:126:handleKline:185239: self.closeSec=1670408699, self.tradeDate='20221207', self.openTime='182000', self.closeTime='182459',self.symbol='BTCUSDT',self.open=16797.8, self.close=16792.7, self.high=16801.1, self.low=16792.0   
2022-12-07 18:25:01,405:INFO:factorcheck2:main.py:127:handleKline:185239: ukdf.iloc[-5:,:] :
     tradeDate openTime closeTime    closeSec  ...      low       pct  index  idx
1656  20221207   180000    180459  1670407499  ...  16812.9 -0.000648   1656    0
1657  20221207   180500    180959  1670407799  ...  16811.1 -0.000030   1657    1
1658  20221207   181000    181459  1670408099  ...  16797.3 -0.000910   1658    2
...
[5 rows x 11 columns]
2022-12-07 18:25:01,405:INFO:factorcheck2:main.py:128:handleKline:185239: self.flagDict={'side': 'buy', 'posBuy': 0, 'posSell': 0, 'isNewDay': True, 'isOpenBuy': True, 'isOpenSell': False, 'isCloseBuy': False, 'isCloseSell': False, 'isOpen': True, 'isClose': False, 'isTrig': True}
